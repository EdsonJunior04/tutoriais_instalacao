...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                // optionsBuilder.UseSqlServer("Data Source=DESKTOP-U20H53U; Initial Catalog=gufi_tarde; user id=sa; pwd=Senai@132;");
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-TE4354L\\SQLEXPRESS; Initial Catalog=gufi_tarde; user id=sa; pwd=senai@132;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Evento>(entity =>
            {
                entity.HasKey(e => e.IdEvento)
                    .HasName("PK__evento__C8DC7BDABC81227C");
                ...
                entity.HasOne(d => d.IdInstituicaoNavigation)
                    ...
                    .HasConstraintName("FK__evento__idInstit__5BE2A6F2");
            ...
            modelBuilder.Entity<ImagemUsuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdUsuario, "UQ__imagemUs__645723A7F0D1328A")
                    .IsUnique();
            ...
            modelBuilder.Entity<Instituicao>(entity =>
            {
                entity.HasKey(e => e.IdInstituicao)
                    .HasName("PK__institui__8EA7AB00ABA786CA");

                entity.ToTable("instituicao");

                entity.HasIndex(e => e.Endereco, "UQ__institui__9456D406E03DE0FF")
                    .IsUnique();

                entity.HasIndex(e => e.Cnpj, "UQ__institui__AA57D6B45734188E")
                    .IsUnique();
            ...
            modelBuilder.Entity<Presenca>(entity =>
            {
                entity.HasKey(e => e.IdPresenca)
                    .HasName("PK__presenca__44CEA4278C69A799");
                ...
                entity.HasOne(d => d.IdEventoNavigation)
                    ...
                    .HasConstraintName("FK__presenca__idEven__73BA3083");

                entity.HasOne(d => d.IdSituacaoNavigation)
                    .WithMany(p => p.Presencas)
                    .HasForeignKey(d => d.IdSituacao)
                    .HasConstraintName("FK__presenca__idSitu__74AE54BC");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Presencas)
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__presenca__idUsua__72C60C4A");
            });

            modelBuilder.Entity<Situacao>(entity =>
            {
                entity.HasKey(e => e.IdSituacao)
                    .HasName("PK__situacao__12AFD19788049EE4");

                entity.ToTable("situacao");

                entity.HasIndex(e => e.Descricao, "UQ__situacao__91D38C289E7C80F6")
                    .IsUnique();
            ...
            modelBuilder.Entity<TipoEvento>(entity =>
            {
                entity.HasKey(e => e.IdTipoEvento)
                    .HasName("PK__tipoEven__09EED93A957A0B03");

                entity.ToTable("tipoEvento");

                entity.HasIndex(e => e.TituloTipoEvento, "UQ__tipoEven__D2A1CBBBDADDAE69")
                    .IsUnique();
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipoUsuario)
                    .HasName("PK__tipoUsua__03006BFF9AAD7C24");

                entity.ToTable("tipoUsuario");

                entity.HasIndex(e => e.TituloTipoUsuario, "UQ__tipoUsua__C6B29FC386E127DD")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__usuario__645723A6ECD3BC80");

                entity.ToTable("usuario");

                entity.HasIndex(e => e.Email, "UQ__usuario__AB6E6164FE985967")
                    .IsUnique();
